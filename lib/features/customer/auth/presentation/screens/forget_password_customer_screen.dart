...
class ForgetPasswordCustomerScreen extends StatelessWidget {
  const ForgetPasswordCustomerScreen({super.key});
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "You will receive an email with a reset link, valid",
                                    style: TextStyle(
                                      color: CupertinoColors.black,
